              ...
              <tbody>
                {users.map((user) => (
                  <tr key={user._id}>
                    ...
                    <td>
                      {user.licenseFrontUrl && user.licenseBackUrl ? (
                        <div className="flex gap-2">
                          <a href={user.licenseFrontUrl} target="_blank" rel="noopener noreferrer">
                            <img
                          ...
                          <a href={user.licenseBackUrl} target="_blank" rel="noopener noreferrer">
                            <img
